...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../index2.html" class="logo">
            ...
            <span class="logo-lg"><b>统一认证中心</b></span>
        </a>
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${request.contextPath}/dist/img/user4-128x128.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${request.contextPath}/dist/img/user3-128x128.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Sales Department
